...
# Sử dụng WhiteNoise để phục vụ static files trong production
...
SECRET_KEY = 'django-insecure-158t80-j!khvja#x=xa$pc7hqi%c%!x)0ajxorjz@z(_jdms5q'
...
INSTALLED_APPS = [
    ...
    'taskboards.apps.TaskboardsConfig',
    'drf_yasg',
]
...
#         'NAME': os.getenv('DB_NAME', 'mcitest'),
